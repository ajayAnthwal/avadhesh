...
import Marketing from "../components/what_we_do/marketing";
import MarketingServices from "../components/what_we_do/MarketingServices";
    ...
    <div>
      <div className="flex flex-col lg:flex-row items-center gap-x-10 bg-white res-desktop w-[90%] m-auto mt-5">
        ...
        <div className="space-y-2 w-full lg:w-96 mb-5 lg:mb-0">
          ...
          <div className="mt-9">
            <button className="btn-gray btn-res">Learn More</button>
          </div>
        </div>
