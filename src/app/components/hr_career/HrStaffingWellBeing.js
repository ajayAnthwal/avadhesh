...
const HrStaffingWellBeing = () => {
  return (
    <div className="py-10 res-desktop px-2 md:px-0">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-[100%] mx-auto mt-6 bottom-service-hr container px-0 md:px-4-5">
