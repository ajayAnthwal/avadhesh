...
const AvatarsSection = () => {
  ...
  const avatars = [
    ...
    { id: 4, name: "Samson Paul", title: "Customer Advisor - Tech", img: "/3.png" },
    { id: 5, name: "Naina", title: "Lead - Strategic Initiatives", img: "/5.png" },
    { id: 6, name: "Bushra Mansoori", title: "Customer Advisor (ISR)", img: "/9.png" },
    { id: 7, name: "Meenakshi Perumal", title: "Customer Advisor ", img: "/7.png" },
    { id: 8, name: "Jyoti Rehal", title: "Customer Advisor", img: "/8.png" },
    { id: 9, name: "Richa Gupta", title: "Business Analyst", img: "/10.png" },
    { id: 10, name: "Aditi Singh", title: "Manager - Cloud Sales", img: "/Aditi-Singh.png" },
    { id: 11, name: "Apurva", title: "Sr. Manager - CRM & Staffing", img: "/Apurva.png" },
    { id: 12, name: "Malavika Batchu", title: "Sr. Business Manager", img: "/Malavika-Batchu.png" },
    { id: 13, name: "Kannha Salooja", title: "SR. Project Manager", img: "/Kannha.png" },
    { id: 14, name: "Muniraj P", title: "Sr. Customer Advisor -Tech", img: "/MuniRaj.png" },
    { id: 15, name: "Shashikant P", title: "Co-founder", img: "/Shashikant.png" },
    { id: 16, name: "Shubham Belorkar", title: "Customer Advisor - Tech", img: "/Shubham.png" },
    { id: 17, name: "Rohit Thakur", title: "Creative Design Manager", img: "/Rohit.png" },
  ];
        ...
        <div className="container mx-auto text-center" ref={viewAllRef}>
          ...
          {!isViewMore ? (
            ...
            <>
              ...
              <button
                className="mt-8 px-6 py-2 bg-red-500 text-white font-semibold rounded-lg hover:bg-red-700"
                onClick={handleViewMore}
              >
                Read Less
              </button>
